"""
Muon optimizer from: https://github.com/MoonshotAI/Moonlight/blob/master/examples/toy_train.py
"""
...
class Muon(torch.optim.Optimizer):
    ...
    Arguments:
        ...
        use_exact_svd: Whether to use exact SVD for orthogonalization instead of Newton-Schulz.
                      Exact SVD is more accurate but potentially slower. (default: False)
